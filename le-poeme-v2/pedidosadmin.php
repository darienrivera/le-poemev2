...
<body>		
    ...
    $productquery= "select * from checkout where delivery='pendiente' ";
...
<td data-th="Delivery" class="text-center">
			<form action="entregar.php?del=<?php echo @$orderid?>" method="post">
			<input name="deleteBtn" type="submit" value="Entregar"  >
		 	</form></td>
</tr>
</tbody>
